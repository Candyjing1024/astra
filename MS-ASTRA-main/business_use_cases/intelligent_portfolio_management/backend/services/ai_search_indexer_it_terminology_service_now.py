...
CONFIG = {
    ...
    "MODULE_NAME": os.getenv("MODULE_NAME", "it-terminology"),
...
fields = [
    ...
    SearchField(name="sys_id",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="number",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="short_description",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="u_kb_reponse",type=SearchFieldDataType.String, searchable=True, sortable=False, filterable=False, facetable=False),
    SearchField(name="u_kb_contexte",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="u_kb_tapes_de_r_alisation",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="kb_knowledge_base",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="workflow_state",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="kb_category",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
    SearchField(name="active",type=SearchFieldDataType.String, searchable=True, sortable=True, filterable=True, facetable=True),
]
...
semantic_config = SemanticConfiguration(
    ...
    prioritized_fields=SemanticPrioritizedFields(
        title_field=SemanticField(field_name="u_kb_reponse"),
        content_fields=[SemanticField(field_name="chunk"), SemanticField(field_name="short_description"), SemanticField(field_name="u_kb_contexte")],
        keywords_fields=[SemanticField(field_name="chunk"), SemanticField(field_name="short_description"), SemanticField(field_name="u_kb_contexte")],
    )
)
...
def create_skillset():
    ...
    inputs=[ 
        ...
        InputFieldMappingEntry(name="text", source="/document/u_kb_reponse")
    ...
    index_projections = SearchIndexerIndexProjection(
        ...
        InputFieldMappingEntry(name="u_kb_contexte",source="/document/u_kb_contexte"),
        InputFieldMappingEntry(name="u_kb_tapes_de_r_alisation",source="/document/u_kb_tapes_de_r_alisation"),
        InputFieldMappingEntry(name="u_kb_reponse",source="/document/u_kb_reponse"),         
        InputFieldMappingEntry(name="short_description",source="/document/short_description"),
        InputFieldMappingEntry(name="sys_id",source="/document/sys_id"),
        InputFieldMappingEntry(name="number",source="/document/number"),
        InputFieldMappingEntry(name="kb_knowledge_base",source="/document/kb_knowledge_base"),
        InputFieldMappingEntry(name="workflow_state",source="/document/workflow_state"),
        InputFieldMappingEntry(name="kb_category",source="/document/kb_category"),
        InputFieldMappingEntry(name="active",source="/document/active"),
                ]
            )
        ],
